(define (problem math_3x3) (:domain math_grid)

(:objects 
    c11 c12 c13 c21 c22 c23 c31 c32 c33 - cell
)
...
(:init
    ...
    ; Counter setting
    (succ num0 num1) (succ num1 num2) (succ num2 num3) (succ num3 num4) (succ num4 num5)
    (sub_count num0)

    ; Connected cells
    (connect c11 c12) (connect c11 c21) (connect c11 c22)
    (connect c12 c11) (connect c12 c22) (connect c12 c13)
    (connect c13 c12) (connect c13 c23) (connect c13 c22)
    (connect c21 c11) (connect c21 c22) (connect c21 c31)
    (connect c23 c13) (connect c23 c22) (connect c23 c33)
    (connect c31 c21) (connect c31 c32) (connect c31 c22)
    (connect c32 c31) (connect c32 c22) (connect c32 c33)
    (connect c33 c23) (connect c33 c32) (connect c33 c22)

    ; Initial State
    (current_num c11 num1) (current_num c12 num1) (current_num c13 num1)
    (current_num c21 num1) (current_num c22 num1) (current_num c23 num1)
    (current_num c31 num1) (current_num c32 num1) (current_num c33 num1)

    ; Goal
    (goal c11 num0) (goal c12 num1) (goal c13 num2)
    (goal c21 num3) (goal c22 num9) (goal c23 num4)
    (goal c31 num5) (goal c32 num7) (goal c33 num8)
)
